...
#   frame1 = cv2.imread('data/456.jpg')
#   bbox_list1 = [(1096, 618, 26, 32), (814, 550, 35, 33), (998, 145, 65, 87), (65, 142, 67, 77), (313, 75, 73, 95)]
# 
#   frame2 = cv2.imread('data/123.jpg')
#   bbox_list2 = [(580, 101, 438, 502)]
# 
#   frame3 = cv2.imread('data/789.jpg')
#   bbox_list3 = [(856, 237, 90, 107), (496, 208, 85, 106)]
...
#   bbox_lists.append(bbox_list1)
#   bbox_lists.append(bbox_list2)
#   bbox_lists.append(bbox_list3)
...
#---------------------------------
    ...
    cap = cv2.VideoCapture('./data/Marquess-Vayamos.avi')#breakupTeacherStudent.mp4')#Marquess-Vayamos.avi')#news_kp_partial.mp4
